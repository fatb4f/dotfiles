...
#SelectionCutoverSnapshot: #ContextGraphSnapshot & {
	...
	modules: {
		"module.fixture": {kind: "repository", name: "fixture", rootNamespaceID: "namespace.fixture"}
	}
	namespaces: {
		"namespace.fixture": {
			moduleID: "module.fixture", parentNamespaceID: null, name: "fixture", kind: "repository-root", rootPath: "."
		}
	}
	members: {
		"member.inside": {
			moduleID: "module.fixture", namespaceID: "namespace.fixture", name: "inside", kind: "file", path: "src/inside"
		}
		"member.outside": {
			moduleID: "module.fixture", namespaceID: "namespace.fixture", name: "outside", kind: "file", path: "other/outside"
		}
	}
	relationships: {}
	evidence:      {}
...
contextSelectionCutoverFixtures: {
	boundary: {
		...
		repositoryRoot: {
			request: #ContextApplicationRequest & {
				schema:       "dotfiles.context-application-request.v0"
				requestID:    "request.cutover-root"
				repository:   "fixture"
				revision:     "HEAD"
				allowedPaths: ["."]
				overlayMode:  "disabled"
	...
	committed: {
		...
		evaluation:    #ContextCommittedSelectionEvaluation & {request: Request, proposal: Proposal, policy: Policy, committedProjection: Projection}
		outsideBoundary: {
			request: #ContextApplicationRequest & {
				schema:       "dotfiles.context-application-request.v0"
				requestID:    Request.requestID
				...
				overlayMode:  "disabled"
				roots:        {memberIDs: [], namespaceIDs: [], pathPrefixes: ["src/main.py"]}
			}
			proposal:            Proposal
			policy:              Policy
...
// Distinct fixtures ensure every original strategy name exercises its claimed mutation.
