...
_issue: {
	number: 0
	title: "template"
	path: "contracts/issues/_template/manifest.cue"
}
...
_validation: impl.#MakeValidationPlan & {
	in: {
		...
		commands: [
			...
			"cue export ./contracts/issues/<issue-number> -e normalizedDotfilesIssueManifest",
			"cue export ./contracts/issues/<issue-number> -e dotfilesValidationPlan",
			"cue export ./contracts/issues/<issue-number> -e dotfilesCompletionReportContract",
