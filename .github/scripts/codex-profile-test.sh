...
cd "$REPO_ROOT"
uv run --project . -- python .codex/codex-profile/tests/test_replay.py -v
uv run --project . -- python .codex/codex-profile/tests/test_ingestion.py -v
uv run --project . -- python .codex/codex-profile/tests/test_verify_upstream.py -v
uv run --project . --group test -- pytest -q \
...
uv run --project . -- python -m compileall -q .codex/codex-profile/src
