...
```sh
$HOME/src/dotfiles/shell-wrap/src/hookrail/hookrail doctor
```

Manual hook run:

```sh
$HOME/src/dotfiles/shell-wrap/src/hookrail/hookrail hook < fixtures/hooks/user-prompt-submit-large.json
```
...
HOOKRAIL_STATE=/tmp/hookrail-state \
  $HOME/src/dotfiles/shell-wrap/src/hookrail/hookrail hook \
