...
`var/run/hookrail/validation-report.latest.json` records a later validation report generated by the legacy validation manifest export.
...
- exports for the legacy relation, authorization evidence, promotion, promoted binding, validation assessment, and validation manifest slices.
